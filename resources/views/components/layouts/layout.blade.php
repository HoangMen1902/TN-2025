            ...
            <div class="md:flex md:items-center md:justify-between md:flex-wrap md:gap-2 md:py-4">
                ...
                <div class="hidden md:flex md:items-center md:gap-6">
                    <div class="text-center">
                        <a href="/thong-bao" class="flex flex-col items-center text-gray-600 text-xs hover:text-blue-600">
...
<div id="drawer-top-example"
    ...
    <footer class="page bg-white py-8 text-sm text-gray-700 max-w-[1200px] w-full mx-auto rounded-lg px-4">
        <div class="flex flex-col md:flex-row gap-6">
            <div class="w-full md:w-[25%] space-y-3 border-b md:border-b-0 md:border-r border-gray-300 md:pr-4 pb-4 md:pb-0">
                <img src="{{ asset('assets/images/logotest1.png') }}" alt="Beebook Logo" class="w-[150px] mx-auto block">
            ...
            <div class="w-full md:w-[75%] space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="hidden md:flex flex-wrap justify-center gap-6 items-center mb-12 px-4 py-8">
                        ...
                        <img src="{{ asset('assets/images/Logo_ninjavan.jpg') }}" alt="Ninja Van" class="h-12 md:h-[70px]">
                    ...
                    <div class="hidden md:flex flex-wrap justify-center gap-6 items-center mt-12 px-4 py-8">
                        ...
                        <img src="{{ asset('assets/images/shopeepay_logo.jpg') }}" alt="ShopeePay" class="h-8 md:h-[40px]">
                        <img src="{{ asset('assets/images/logo_zalopay_2.png') }}" alt="ZaloPay" class="h-8 md:h-[40px]">
                    </div>
        ...
        <p class="text-xs mt-10 text-center break-all text-gray-500 leading-relaxed">
            Giấy chứng nhận Đăng ký Kinh doanh số <strong>0304132047</strong> do Sở KH&ĐT TP.HCM cấp ngày <strong>20/12/2005</strong>,<br>
