<x-layouts.layout>
    ...
    <div class="bg-gray-100 text-gray-900 flex justify-center min-h-screen px-4">
        <div
            class="w-full max-w-[1200px] m-0 mb-8 bg-white shadow sm:rounded-lg flex flex-col lg:flex-row justify-center flex-1">
            <div class="w-full lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                ...
                <div class="w-full mt-4">
                    <form action="{{ route('update-password') }}" method="POST" class="mx-auto max-w-xs" novalidate>
                        ...
                        <button type="submit" class="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg 
                        ...
                        <p class="mt-6 text-xs text-gray-600 text-center">
                            <a href="{{ route('login') }}"
                                class="border-b border-gray-500 border-dotted text-indigo-600 hover:text-indigo-800">
                                Quay lại đăng nhập
                            </a>
                        </p>
                    </form>
