<div>
    <div class="flex flex-col md:flex-row w-full">
        ...
        <div class="bg-white w-full md:w-[900px] py-4 md:py-8 rounded shadow-sm">
                        ...
                        <div class="flex flex-col md:flex-row md:justify-between">
                            <div>
                                ...
                                @if($address->address_default)
                                    <div class="mt-2">
                                        <span class="text-xs border border-red-500 text-red-500 px-2 py-0.5 rounded">Mặc
                                            định</span>
                                    </div>
                                @endif
                            </div>
                            <div class="flex flex-col md:flex-col mt-3 md:mt-0">
                                <div class="flex gap-4 mb-2">
                                    <button wire:click="openUpdateModal({{ $address->id }})"
            ...
            <!-- Modal Form Cập nhật -->
            <div
                class="fixed {{$showUpdateModal ? '' : 'hidden'}} inset-0 bg-opacity-50 z-50 flex items-center justify-center">
                <div
                    class="bg-white rounded-lg shadow-lg w-full max-w-md mx-4 transform transition-transform duration-300">
                    <div class="p-4 md:p-6">
                        ...
                        <form wire:submit.prevent="updateAddress">
                            ...
                            <div class="mb-4">
                                ...
                                <select wire:model="update_ward_id"
                                    class="w-full border border-gray-300 p-2 rounded-md">
                            ...
                            <div class="mb-4 md:mb-6">
                                ...
                                <div class="flex gap-3 md:gap-4">
                                    <label>
                                        <input type="radio" wire:model="update_address_type" value="home"
                                            class="hidden peer">
                                        <span
                                            class="px-3 py-2 border rounded cursor-pointer peer-checked:bg-blue-100">Nhà
                                            riêng</span>
                                    </label>
                                    <label>
                                        <input type="radio" wire:model="update_address_type" value="office"
                                            class="hidden peer">
                                        <span
                                            class="px-3 py-2 border rounded cursor-pointer peer-checked:bg-blue-100">Văn
                                            phòng</span>
                                    </label>
                                </div>
                            ...
                            <div class="flex gap-3 md:gap-4">
                                <button type="button" wire:click="closeUpdateModal"
                                    ...
                                    Lại</button>
                                <button type="submit"
                                    class="flex-1 py-2 bg-blue-500 hover:bg-blue-600 rounded font-medium text-white text-sm md:text-base">Cập
                                    nhật</button>
                            </div>
                        </form>
