<x-layouts.layout>
    <div class="container mx-auto max-w-[1200px] my-3 md:my-6 flex flex-col md:flex md:flex-row md:h-[700px] px-4 md:px-0">
        ...
        <div class="bg-white w-full md:w-[900px] py-4 md:py-8 rounded shadow-sm">
            ...
            <livewire:usermodule::components.update-infomation />
