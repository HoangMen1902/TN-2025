        ...
        <div class="flex flex-col md:flex-row md:h-full w-full">
            ...
            <div class="bg-white w-full md:w-[900px] py-4 md:py-8 rounded shadow-sm">
                ...
                <div class="mb-4 border-b border-gray-200 relative">
                    ...
                    <div class="flex overflow-x-auto scrollbar-hide" id="orderTabs" data-tabs-toggle="#orderTabContent"
                        role="tablist">
                        <ul class="flex flex-nowrap whitespace-nowrap min-w-full">
                            <li class="mr-2" role="presentation">
                                <button class="inline-block p-4 border-b-2 border-red-500 text-red-500 rounded-t-lg"
                            ...
                            <li class="mr-2" role="presentation">
                                <button
                                    ...
                                    id="pending-payment-tab" data-tabs-target="#pending-payment" type="button"
                                    role="tab" aria-controls="pending-payment" aria-selected="false">
                                    Chờ thanh toán
                                </button>
                            </li>
                            <li class="mr-2" role="presentation">
                            ...
                            <li class="mr-2" role="presentation">
                                <button
                                    class="inline-block p-4 border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 rounded-t-lg"
                                    id="waiting-delivery-tab" data-tabs-target="#waiting-delivery" type="button"
                                    role="tab" aria-controls="waiting-delivery" aria-selected="false">
                                    Chờ giao hàng
                                </button>
                            </li>
                            <li class="mr-2" role="presentation">
                            ...
                            <li role="presentation">
                                <button
                                    class="inline-block p-4 border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 rounded-t-lg"
                                    id="refund-tab" data-tabs-target="#refund" type="button" role="tab"
                ...
                <div id="orderTabContent">
                    ...
                    <div class="block" id="all" role="tabpanel" aria-labelledby="all-tab">
                        <div class="border border-gray-200 rounded-lg mx-4 mb-4">
                            ...
                            <div class="p-3 md:p-4 flex flex-col md:flex-row md:justify-between md:items-center gap-2">
                                <div class="flex items-center">
                                    <svg class="text-green-500 w-4 h-4 md:w-5 md:h-5 mr-1" fill="none"
                    ...
                    <div class="hidden" id="pending-payment" role="tabpanel" aria-labelledby="pending-payment-tab">
                        <div class="flex flex-col items-center justify-center py-12">
                            <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160.001"
                                viewBox="0 0 160 160.001" class="mdl-js">
                                <g transform="translate(-114.83 -59.67)">
                                    ...
                                    <path class="h"
                                        d="M179.407,158.305s-2.246-14.065,8.04-14.065,7.754,14.065,7.754,14.065"
                                    ...
                                    <g transform="translate(175.971 80.445)"><text class="j"
                    ...
                    <div class="hidden" id="completed" role="tabpanel" aria-labelledby="completed-tab">
                        <div class="block" id="all" role="tabpanel" aria-labelledby="all-tab">
                            <div class="border border-gray-200 rounded-lg mx-4 mb-4">
                                ...
                                <div
                                    class="p-3 md:p-4 flex flex-col md:flex-row md:justify-between md:items-center gap-2">
                                    <div class="flex items-center">
                                        <svg class="text-green-500 w-4 h-4 md:w-5 md:h-5 mr-1" fill="none"
    ...
    <div class="w-full max-w-xl bg-white rounded-lg shadow max-h-[100vh] overflow-y-auto">
        ...
        <div class="p-6 space-y-6">
            <div class="flex items-start border-b border-gray-200 pb-4">
                ...
                <div class="flex-1 min-w-0">
                    <p class="font-medium mb-1 text-sm md:text-base line-clamp-2">Tuyển Sinh 10 & Các Đề Toán Thực Tế
