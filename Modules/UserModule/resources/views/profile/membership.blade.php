    ...
    <div class="container mx-auto max-w-[1200px] my-3 md:my-6 flex flex-col md:flex md:flex-row md:h-[650px] px-4 md:px-0">
        ...
        <div class="bg-white w-full md:w-[900px] py-4 md:py-8 rounded shadow-sm">
            <div class="mb-4 md:mb-6">
                <h1 class="text-xl md:text-2xl font-medium ml-4">Hệ thống cấp bật thành viên</h1>
                <p class="text-gray-600 text-xs md:text-sm ml-4">Khi đạt được danh hiệu bạn sẽ nhận được những quyền lợi tương ứng</p>
