<div class="container max-w-[1200px] mx-auto bg-white rounded mb-4">
    ...
    <div class="bg-white p-2 flex justify-end items-center mb-2">
        <div class="relative">
            <div class="border border-gray-300 rounded px-2 py-1 bg-white cursor-pointer flex items-center"
            ...
            <div id="dropdownMenu"
                class="absolute hidden top-full right-0 w-40 bg-white border border-gray-300 rounded shadow-lg z-10">
    ...
    <div>
        <div class="flex flex-wrap gap-3 p-3">
            @forelse ($combos as $combo)
                <a href="/chi-tiet-combo/{{ $combo->slug }}"
    ...
    @if($canLoadMore)
        <button 
            ...
            class="inline-block px-8 py-1.5 border-2 border-red-600 rounded text-red-600 font-bold hover:bg-red-600 hover:text-white transition-colors duration-300"
            wire:loading.remove
        >
            Xem Thêm
        </button>

        <div wire:loading class="text-red-600 font-bold mt-2">
            Đang tải...
         
        </div>
    @else
        <span class="text-gray-500">Đã tải hết combo</span>
    @endif
</div>
