    ...
    <div class="my-8 max-w-[1200px] m-auto ">
        ...
        <div class="flex">
            <form action="/image-search" method="POST" enctype="multipart/form-data"
                class="w-1/2 bg-white rounded-lg p-3 flex flex-col justify-between" onsubmit="loading()">
                @csrf
                <div class="relative">
                    <input type="file" id="dropzone-file" class="filepond w-full" name="imageSearch" />
                </div>
                <div class="flex items-center justify-center gap-2">
                    <button id="searchBtn" class="px-6 py-2 transition duration-300 cursor-pointer bg-primary text-white font-semibold rounded">
                        Tìm kiếm
